      ...
      {carouselImg.map((item) => {
        return (
          <div className="relative w-full h-[410px] lg:h-[845px]" key={item.id}>
            ...
            />
            <div className="pl-6.5 2xl:px-2xl-2  xl:pl-[150px] flex bg-[rgba(18,18,18,0.35)] flex-col justify-center 2xl:justify-end text-white absolute top-0 left-0 right-0 bottom-0">
              <div className="xl:w-2/3 2xl:w-3/4 2xl:mb-48">
                ...
                <h1 className="text-[48px] md:text-[60px] lg:text-[70px] xl:text-[90px] 2xl:text-[115px] leading-tight	">
