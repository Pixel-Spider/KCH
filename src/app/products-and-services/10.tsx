const Project10 = () => {
  return (
    <div id="product-10" className="w-full">
      <div
        style={{
      ...
      >
        ...
        >
          <div className="relative 2xl:max-w-[801px] xl:max-w-[601px]">
            ...
            >
              Green Innovations: Nurturing a Sustainable Future with Our
            ...
            >
              Sustainable and environmentally friendly chemicals, such as
              eco-friendly solvents and biodegradable additives, contribute to
              en- vironmentally conscious practices.
            </p>
            <ul className="text-white list-disc pl-6">
              ...
              >
                Hydrochloric Acid Replacement Products
              </li>
              <li
                data-aos="fade-up"
                data-aos-duration="1000"
                ...
                className="font-normal xl:text-2xl 2xl:text-[29px]"
              >
                Micro emulsions & nanotechnology
              </li>
              <li
                data-aos="fade-up"
                data-aos-duration="1000"
