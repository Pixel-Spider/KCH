const Project7 = () => {
  return (
    <div id="product-7" className="w-full">
      <div
        style={{
      ...
      >
        ...
        >
          <div className="relative 2xl:max-w-[801px] xl:max-w-[601px]">
            ...
            >
              Transforming Earth: Explore Our Sustainable Soil Remediation
              Chemicals
            </h3>
            <p
              data-aos="fade-up"
            ...
            >
              Chemicals are employed to mitigate and manage soil contamina-
              tion, facilitating the restoration of polluted or impaired land to
              its original or acceptable state.
            </p>
